		...
		$pointers = [
			[
				...
				'content' => sprintf(
					...
					esc_html__( 'The BoldGrid Color Palette System allows you to create custom color palettes. Try changing the order of colors in a palette, or use Suggest Palettes to automatically generate new palettes. For more information about using this tool, view our', 'crio' ),
					esc_html__( 'customizer tutorials', 'crio' )
				),
				'position' => [
					'edge' => 'left',
					'align' => 'top',
