				...
				<?php if ( get_option( 'fresh_site' ) ) : ?>
					<div class="welcome-panel-column">
						...
						<?php if ( ! file_exists( WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . $crio_editor_file ) ) : ?>
							<p>
								<a href="<?php echo esc_url( $crio_tgm_url ) ?>" class="button button-primary button-hero crio-welcome-button"><?php esc_html_e( 'Install Post and Page Builder', 'crio' ); ?></a>
							</p>
							<p>
		...
		<div class="welcome-panel-content">
			<div class="welcome-panel-column-container">
				...
				<div class="wrapper">
					...
					<p class="box">
						<a href="https://www.boldgrid.com/feedback/communities/20-questions" target="_blank" class="button button-secondary"><?php esc_html_e( 'Get Support', 'crio' ); ?></a>
					</p>
					<p class="box">
		...
		<div class="welcome-panel-content">
			<div class="welcome-panel-column-container two-col">
				<div class="welcome-panel-column">
					...
					<p><?php esc_html_e( 'Crio Pro gives you access to advanced features and more control over your designs. For a one-time cost of $39 you can design your site with professional level confidence.', 'crio' ); ?></p>
					<p>
						<a href="https://www.boldgrid.com/get-pro-crio/" target="_blank" class="button button-primary button-hero"><?php esc_html_e( 'Get Crio Pro', 'crio' ); ?></a>
					</p>
				</div>
				<div class="welcome-panel-column">
