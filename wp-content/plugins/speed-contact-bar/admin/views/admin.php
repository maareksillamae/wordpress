		...
		<div id="th_footer">
			<div class="th_content">
				...
				<dl>
					...
					<dt><?php esc_html_e( 'Plugin development by', 'speed-contact-bar' ); ?></dt><dd><a href="https://stehle-internet.de/?ref=speed-contact-bar"> <?php echo get_avatar( 'shop@stehle-internet.de', 44 ); ?>Stehle Internet</a></dd>
				</dl>
			</div><!-- .th_content -->
		</div><!-- #th_footer -->
	</div><!-- .th_wrapper -->
