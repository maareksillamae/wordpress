...
7. any further content you wish by using the filter hook `speed-contact-bar-data` (as documented in FAQ section &quot;How to add and re-order list entries by using hooks&quot;).
...
16. Yelp
17. Youtube
18. any further content you wish by using the filter hook `speed-contact-bar-icons` (as documented in FAQ section &quot;How to add and re-order list entries by using hooks&quot;).
